...
class DocumentType(enum.Enum):
    ...
    RENTAL_APPLICATION_FORM_SUBMITTED = "RENTAL_APPLICATION_FORM_SUBMITTED"
    ...
    RECEIPT_PAYMENT_FROM_TENANT = "RECEIPT_PAYMENT_FROM_TENANT"
